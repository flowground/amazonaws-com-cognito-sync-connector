# ![LOGO](logo.png) Amazon Cognito Sync MSP Connector

## Description

A generated MSP connector for the Amazon Cognito Sync API (version 2014-06-30).
...
flowground :- Telekom iPaaS / amazonaws-com-cognito-sync-connector<br/>
